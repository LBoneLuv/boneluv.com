...
import { useIdentityContext as useIdentityContext$1, IdentityContextProvider as IdentityContextProvider$1 } from 'react-netlify-identity';
export { useNetlifyIdentity } from 'react-netlify-identity';
...
function Login(_ref) {
  ...
  var _useIdentityContext = useIdentityContext$1(),
  ...
  }, "Entrar"), msg && React.createElement("pre", {
    style: {
      background: 'salmon',
      padding: 10
    }
...
function Logout(_ref) {
  ...
  var identity = useIdentityContext$1();
  ...
  }, "Mi cuenta")), React.createElement("form", {
    className: "form "
  }, React.createElement("p", {
    className: "RNIW_infoText"
  }, "Has entrado como ", React.createElement("br", null), React.createElement("span", {
    className: "RNIW_infoTextEmail"
  }, name)), React.createElement("button", {
    type: "submit",
    className: isLoading ? 'RNIW_btn RNIW_saving' : 'RNIW_btn',
    onClick: logout
  }, "Salir"), msg && React.createElement("pre", {
    style: {
      background: 'salmon',
      padding: 10
    }
...
function Signup(_ref) {
  ...
  return React.createElement("form", {
    ...
    type: "submit",
    className: isLoading ? 'RNIW_btn RNIW_saving' : 'RNIW_btn'
  }, "Registrarse"), msg && React.createElement("pre", {
    style: {
      background: 'salmon',
      padding: 10
    }
...
function Providers() {
  ...
  }, isLocalhost && React.createElement("pre", null, "\u26A0\uFE0FTesting providers"), React.createElement("hr", {
    className: "RNIW_hr"
...
function ProviderButton(_ref2) {
  ...
  var _useIdentityContext2 = useIdentityContext$1(),
...
function LoggedOutScreen(props) {
  ...
  }, "Iniciar sesión"), React.createElement(Tab, {
    className: "RNIW_btn RNIW_btnHeader"
  }, "Registro")), React.createElement(TabPanels, null, React.createElement(TabPanel, null, React.createElement(Login, {
    onLogin: props.onLogin
  })), React.createElement(TabPanel, null, React.createElement(Signup, {
...
var IdentityContextProvider = IdentityContextProvider$1;
var useIdentityContext = useIdentityContext$1;
...
export { IdentityContextProvider, IdentityModal, useIdentityContext };
