...
module.exports = (config = {}, rootDir = null) => {
  ...
  if (config.plugins) {
    const pageCreatorPlugin = config.plugins.find(plugin => plugin.resolve === `gatsby-plugin-page-creator` && plugin.options.path === slash(path.join(program.directory, `src/pages`)));
